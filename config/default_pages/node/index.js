...
<body>
  <div class="container">
    <div class="badge">
      ...
      Node.js Stack Ready & Running
    </div>
    <h1>${PROJECT_NAME}</h1>
    <p class="subtitle">Your Node.js application is running locally on Laraflare.</p>
    ...
    <div class="grid">
      ...
      <div class="info-card">
        <span>Uptime</span>
        <strong>${Math.floor(process.uptime())}s</strong>
      </div>
    </div>
...
server.listen(PORT, () => {
  console.log(`[Laraflare] ${PROJECT_NAME} HTTP server listening on port ${PORT}`);
});
